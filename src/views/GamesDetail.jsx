  ...
  const renderStars = (rating, size = "text-xl") => {
    ...
    for (let i = 0; i < 5; i++) {
      if (i < fullStars) {
        ...
        stars.push(<FaRegStarHalf key={i} className={`${size} text-yellow-400`} />);
      } else {
            ...
            {activeTab === "Details" && (
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="text-gray-300">
                    Metaphor: ReFantazio is an action-adventure role-playing game set in a visually stunning world, 
                    blending traditional RPG elements with modern mechanics. The game follows a group of protagonists 
                    as they uncover the mysteries of a crumbling society and embark on a quest to save the world. With a 
                    rich narrative, deep combat system, and complex character interactions, the game offers players an 
                    unforgettable experience that pushes the boundaries of the genre.
                  </p>
                </div>
          ...
          <div className="place-items-center order-first lg:order-last pt-8 lg:pl-5 xl:pl-0">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-4 flex items-center justify-center">
                <div className="flex space-x-1">
                  {renderStars(rating)} {/* Dynamically rendered stars */}
                </div>
                <p className="ml-2 text-lg text-gray-300">{rating.toFixed(1)}/5.0</p>
              </div>
            </div>
          </div>
        </div>
