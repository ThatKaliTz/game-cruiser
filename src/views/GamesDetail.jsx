...
const gameGuides = [
  {
    ...
    description:
      "Get started with the basics and essential tips to kickstart your journey.",
    link: "#",
  },
  {
    id: 2,
    ...
    description:
      "Learn advanced combat techniques to defeat the toughest enemies.",
    link: "#",
  },
  {
    id: 3,
    ...
    description:
      "Find all hidden items, collectibles, and secrets in the game.",
    link: "#",
  },
  {
    id: 4,
    ...
    description:
      "Detailed strategies for tackling each boss and their unique mechanics.",
    link: "#",
  },
];
...
const forumTopics = [
  {
    ...
    description: "Share your best tips for new players.",
    posts: 12,
    link: "/forum/tips-for-beginners",
  },
  {
    id: 2,
    title: "Advanced Strategies",
    description: "Discuss advanced strategies for endgame.",
    posts: 8,
    link: "/forum/advanced-strategies",
  },
  {
    id: 3,
    title: "Favorite Characters",
    description: "Who are your favorite characters?",
    posts: 15,
    link: "/forum/favorite-characters",
  },
  {
    id: 4,
    title: "Latest Patch Notes",
    description: "Talk about the latest game updates.",
    posts: 5,
    link: "/forum/latest-patch-notes",
  },
];
...
const GameDetails = () => {
    ...
    const fetchGameDetails = async () => {
      try {
        const response = await fetch(
          `http://localhost:5119/api/juegos/${nombre}`
  ...
  const handleSubmitReview = async () => {
    const userDta = localStorage.getItem("loggedInUser")
    const usuarioDatos = JSON.parse(userDta);

    const updateResponse = await fetch("http://localhost:5119/api/review/", {
      method: "POST",
      headers: {
  ...
  const currentReviews = [
    {
      ...
      rating: 5,
      comment:
        "An amazing experience with stunning visuals and engaging gameplay!",
    },
    {
      coverImage: "https://via.placeholder.com/100",
      gameName: "Metaphor: ReFantazio",
      rating: 4,
      comment:
        "Fantastic story and immersive world. Could use more side quests!",
    },
    {
      coverImage: "https://via.placeholder.com/100",
      gameName: "Metaphor: ReFantazio",
  ...
  const currentReviewsPage = currentReviews.slice(
    indexOfFirstReview,
    indexOfLastReview
  );
  ...
  const renderStars = (rating, size = "text-xl") => {
    ...
    for (let i = 0; i < 5; i++) {
      if (i < fullStars) {
        ...
        stars.push(
          <FaRegStarHalf key={i} className={`${size} text-yellow-400`} />
        );
      } else {
  ...
  return (
    <div className="bg-black text-white min-h-screen p-6">
      <div className="container mx-auto px-[90px]">
        {/* Main Content Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-[50px] mb-[70px]">
          ...
          <div className="lg:col-span-2">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-md font-semibold hover:bg-yellow-500 hover:text-black mr-2 ${
                      activeTab === tab
                        ...
                        : "bg-primary border border-yellow-500 text-white"
                    }`}
                  >
                    {tab}
                  </button>
            ...
            {activeTab === "Details" && (
              <div>
                ...
                <div className="mt-4 flex justify-between bg-blueish p-4 rounded-lg shadow-lg">
                  <div className="text-center sm:px-2 xl:px-7">
                ...
                {/* Sinopsis: Game Description */}
                <div className="mt-6">
                  <h3 className="text-2xl font-semibold mb-2">Sinopsis</h3>
                  <p className="text-gray-300">{game.sinopsis}</p>
                </div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <div>
                    <h4 className="text-xl font-semibold">Released</h4>
                    <p>{game.anio}</p>
                  </div>
                </div>
            ...
            {activeTab === "Reviews" && (
              <div className="space-y-4 mt-5">
                <h2 className="text-2xl font-semibold mb-4">Ya jugaste el juego? Escribe una review!</h2>
                 {/* Button to create a new topic */}
                 <button
                  onClick={handleCreateTopic}
                  className="bg-yellow-500 text-black px-4 py-2 rounded-lg font-semibold mb-6"
                >
                  {isCreatingTopic ? "Cancel" : "Escribir"}
                </button>
                  ...
                  <div className="bg-gray-800 p-4 rounded-lg shadow-md mb-6">
                    <label className="block text-white mb-2">
                      ...
                      <input
                        ...
                        className="bg-primary w-full p-2 mt-1 rounded-lg text-white"
                    ...
                    <label className="block text-white mb-2">
                      ...
                      <textarea
                        ...
                        onChange={handleInputChangeReview}
                        className="bg-black w-full p-2 mt-1 rounded-lg text-white"
                    ...
                    <label className="block text-white mb-2">
                      ...
                      <input
                        ...
                        value={newReview.title}
                        onChange={handleInputChangeReview}
                        className="bg-primary w-1/7 p-2 ml-2 mt-1 rounded-lg text-white"
                        placeholder="0"
                      />
                    </label>
                ...
                <h2 className="text-2xl font-semibold mb-4">Game Reviews</h2>
                {/* Reviews Content */}
          ...
          {/* Image and Overall Star Score */}
          <div className="place-items-center order-first lg:order-last pt-8 lg:pl-5 xl:pl-0">
